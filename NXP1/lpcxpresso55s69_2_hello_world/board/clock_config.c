...
- {id: SYSCON.PLL1M_MULT.scale, value: '75'}
- {id: SYSCON.PLL1N_DIV.scale, value: '4'}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll1Setup = {
        .pllctrl = SYSCON_PLL1CTRL_CLKEN_MASK | SYSCON_PLL1CTRL_SELI(39U) | SYSCON_PLL1CTRL_SELP(19U),
        .pllndec = SYSCON_PLL1NDEC_NDIV(4U),
        .pllpdec = SYSCON_PLL1PDEC_PDIV(1U),
        .pllmdec = SYSCON_PLL1MDEC_MDIV(75U),
        .pllRate = 150000000U,
        .flags =  PLL_SETUPFLAG_WAITLOCK
    };
