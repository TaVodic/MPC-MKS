...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		//float koef = 0.122314453125;
		//float koef2 = 0.002197265625;
		//sct_value((uint16_t)avg_pot*koef, (uint16_t)avg_pot*koef2);
		...
		switch (state) {
		case SHOW_POT:
			sct_value((raw_pot * 501) / 4096, (raw_pot * 9) / 4096); // efektivnejsie, nasobenie int a potom delenie int, co optimalizace upravy na bitovy posun
			break;
		case SHOW_TEMP:
